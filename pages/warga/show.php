...
<table class="table table-striped">
  ...
  <tr>
    <th>Email</th>
    <td>:</td>
    <td><?php echo $data_warga[0]['email_warga'] ?></td>
  </tr>
  <tr>
    <th>No Handphone</th>
    <td>:</td>
    <td><?php echo $data_warga[0]['no_warga'] ?></td>
  </tr>
  <tr>
    <th>Tempat Lahir</th>
    <td>:</td>
...
<table class="table table-striped">
  ...
  <tr>
    <th>Riwayat Hidup</th>
    <td>:</td>
    <td><?php echo $data_warga[0]['riwayat_warga'] ?></td>
  </tr>
</table>
...
<table class="table table-striped">
  <tr>
    ...
    <td width="1%">:</td>
    <td><?php echo $db->query("SELECT nama_user FROM user WHERE id_user = '".$data_warga[0]['id_user']."'")->fetch_assoc()['nama_user'] ?></td>
  </tr>
  <tr>
    <th>Diinput</th>
    <td>:</td>
