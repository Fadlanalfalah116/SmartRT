...
$no_warga = htmlspecialchars($_POST['no_warga']);
...
$riwayat_warga = htmlspecialchars($_POST['riwayat_warga']);

$id_user = $_SESSION['user']['id_user'];

// masukkan ke database

$query = "INSERT INTO warga (id_warga, nik_warga, nama_warga, email_warga, no_warga, tempat_lahir_warga, tanggal_lahir_warga, jenis_kelamin_warga, desa_kelurahan_warga, kecamatan_warga, kabupaten_kota_warga, provinsi_warga, negara_warga, rt_warga, rw_warga, agama_warga, pendidikan_terakhir_warga, pekerjaan_warga, status_perkawinan_warga, status_warga, riwayat_warga, id_user, created_at, updated_at) VALUES (NULL, '$nik_warga', '$nama_warga', '$email_warga', '$no_warga', '$tempat_lahir_warga', '$tanggal_lahir_warga', '$jenis_kelamin_warga', '$desa_kelurahan_warga', '$kecamatan_warga', '$kabupaten_kota_warga', '$provinsi_warga', '$negara_warga', '$rt_warga', '$rw_warga', '$agama_warga', '$pendidikan_terakhir_warga', '$pekerjaan_warga', '$status_perkawinan_warga', '$status_warga', '$riwayat_warga', '$id_user', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000');";
...
if ($hasil == true) {
  ...
  echo "<script>window.alert('Tambah warga gagal!'); window.location.href='../warga'</script>";
}
