...
<table class="table table-striped table-condensed table-hover" id="datatable">
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><?php echo $warga['email_warga'] ?></td>
      <td><?php echo $warga['no_warga'] ?></td>
      <td><?php echo $warga['jenis_kelamin_warga'] ?></td>
      <td><?php echo ($warga['tanggal_lahir_warga'] != '0000-00-00') ? date('d-m-Y', strtotime($warga['tanggal_lahir_warga'])) : ''?></td>
      ...
      <td><?php echo $warga['riwayat_warga'] ?></td>
      <td>
        <!-- Single button -->
...
<div class="well">
  <dl class="dl-horizontal">
    ...
    <dt>Warga Yang Meninggal Dunia:</dt>
    <dd><?php echo $jumlah_warga_meninggal['total'] ?> orang</dd>

    <dt>Warga Yang Belum Mempunyai Pekerjaan:</dt>
    <dd><?php echo $jumlah_warga_tanpa_pekerjaan['total'] ?> orang</dd>
