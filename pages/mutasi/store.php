...
$riwayat_mutasi = htmlspecialchars($_POST['riwayat_mutasi']);
...
$query = "INSERT INTO mutasi (nik_mutasi, nama_mutasi, tempat_lahir_mutasi, tanggal_lahir_mutasi, jenis_kelamin_mutasi, desa_kelurahan_mutasi, kecamatan_mutasi, kabupaten_kota_mutasi, provinsi_mutasi, negara_mutasi, rt_mutasi, rw_mutasi, agama_mutasi, pendidikan_terakhir_mutasi, pekerjaan_mutasi, status_perkawinan_mutasi, status_mutasi, riwayat_mutasi, id_user, created_at, updated_at) VALUES ('$nik_mutasi', '$nama_mutasi', '$tempat_lahir_mutasi', '$tanggal_lahir_mutasi', '$jenis_kelamin_mutasi', '$desa_kelurahan_mutasi', '$kecamatan_mutasi', '$kabupaten_kota_mutasi', '$provinsi_mutasi', '$negara_mutasi', '$rt_mutasi', '$rw_mutasi', '$agama_mutasi', '$pendidikan_terakhir_mutasi', '$pekerjaan_mutasi', '$status_perkawinan_mutasi', '$status_mutasi', '$riwayat_mutasi', '$id_user', CURRENT_TIMESTAMP, '0000-00-00 00:00:00.000000');";
